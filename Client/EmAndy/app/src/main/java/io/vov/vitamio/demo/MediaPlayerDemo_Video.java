	...
	private void playVideo(Integer Media) {
		...
		try {
			...
			case LOCAL_VIDEO:
				 ...
				 */
				path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/tencent/QQfile_recv/shortipfamily.mp4";
				if (path == "") {
			...
			case STREAM_VIDEO:
				 ...
				 * 
				 */
				path = "http://192.168.200.26:8887/docs/shortipfamily.mp4";
				if (path == "") {
					// Tell the user to provide a media file URL.
